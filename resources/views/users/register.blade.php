...
@section('content')
    ...
    <form class='flex flex-col items-center h-[70%]'method='POST' action="/users">
        @csrf
        ...
        @enderror
        <br>
        <button class=' bg-sky-500 h-[15%] w-[30%] shadow-sm shadow-gray-500 p-4 font-bold text-2xl text-center text-white '
